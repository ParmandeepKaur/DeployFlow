      ...
      try {
        ...
        try {
          ...
          if (dashboardRes.ok) {
            ...
            setProjectsCount(dashboardData.totalProjects)
            setContainersCount(dashboardData.runningContainers)
            setPipelineStatus(dashboardData.pipelineStatus)
            setDeploymentStatus(dashboardData.deploymentStatus)
          }
        } catch (err) {
        ...
        // ---------------------------
        // REAL DEPLOYMENTS / CONTAINERS
        // ---------------------------
        let systemContainers = []

        try {
          const deploymentsRes = await fetch(
            'http://localhost:5000/api/deployments/status'
          )
  ...
  return (
    <div className="dashboard-container">
      <div>
        ...
        >
          Real-time insight into DeployFlow pipeline and
